...
class Json_change_tracker
        ...
        def go(json_text, pretty=false, headers=nil)
                if !json_text
                ...
                if pretty
                        ...
                        headers['Content-Type'] = 'text/plain' if headers  # this is to not lose the pretty formatting when sent on to ui.htm or a browser
                end
        ...
        class << self
                ...
                def assert_error_result_from_json(expected_result, json_input, expected_http_response_code, title)
                ...
                def test_nonexistent_codeline()
                        ...
                        assert_error_result_from_json(expected, z, 500, "nonexistent codeline")
                end
                def test()
