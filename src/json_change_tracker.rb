...
class Json_change_tracker
        ...
        class << self
                ...
                def test_steve_roth_v23()
                        ...
                        assert_error_result_from_s('["incomparable","incomparable","incomparable","incomparable","incomparable","incomparable","incomparable","incomparable","incomparable","incomparable"]', "list_changes_between", z1, z2, 200, "changes in full steve roth comparison")
                        assert_error_result_from_s('["incomparable","incomparable","incomparable","incomparable","incomparable","incomparable","incomparable","incomparable","incomparable","incomparable"]', "list_files_changed_between", z1, z2, 200, "files changed in full steve roth comparison")
                        assert_error_result_from_s('["incomparable","incomparable","incomparable","incomparable","incomparable","incomparable","incomparable","incomparable","incomparable","incomparable"]', "list_bug_IDs_between", z1, z2, 200, "bug IDs in full steve roth comparison")
                end
